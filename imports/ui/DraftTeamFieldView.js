...
function DraftTeamFieldView(props) {
                                ...
                                <Grid.Column key={player.id}>
                                    <div>
                                        <Image style={{textAlign: '-webkit-center'}} wrapped size='tiny'
                                               src={`https://fantasy.premierleague.com/static/libsass/plfpl/dist/img/shirts/standard/shirt_${player.team_code}_1-132.webp`}/>
                                    </div>
                        ...
                        <Grid.Row columns={numberPerPosition(teamArray(props.roster,props.eplInfo.elements)).position_2}>
                            {teamArray(props.roster,props.eplInfo.elements).filter(x => x.element_type === 2).map((player, index) =>
                                ...
                                <Grid.Column key={player.id}>
                                    <div>
                                        <Image style={{textAlign: '-webkit-center'}} wrapped size='tiny'
                                               src={`https://fantasy.premierleague.com/static/libsass/plfpl/dist/img/shirts/standard/shirt_${player.team_code}-132.webp`}/>
                                    </div>
                                    <Label style={{marginTop: '3px',color:'white',backgroundColor:'teal'}} basic>
                                        <PlayerModal
                                            info={player}
...
export default DraftTeamFieldView
